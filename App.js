...
const heading1_jsx = <h1 id="heading1">Heading 1 from JSX</h1>

const heading2_jsx = <h2 id="heading2">Heading 2 from JSX</h2>

const heading3_jsx = <h3 id="heding3">Heading 3 from JSX</h3>
...
const header = React.createElement(
  ...
  [React.createElement(
    ...
    { id: "heading1" },
    "Heading1"
  ), heading2_jsx, heading3_jsx]
)

const header_jsx = <div>
  <h1>Heading 1 jsx</h1>
  <h2>Heading 2jsx</h2>
  <h3>Heading 3 jsx</h3>
</div>
...
const HeaderComponent = () => {
  return (
    <div id="header">
      {heading1_jsx}
      <HeaderSubComponent />
      <h2>Heading Element2</h2>
      <h3>Heading Element3</h3>
    </div>
  )
}
  ...
  return (
    <a href="/">
      <img
        ...
        // src="https://images.app.goo.gl/bSGjuHELNLgfsoJ79"
        // width="50px"
        // height="50px"
        className="logo-img"
        alt="logo_img" />
...
const SearchBar = () => {
  return (
    <input className="search-input" type="text" placeholder="Search your menu" />
  )
}
